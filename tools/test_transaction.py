...
from TransPose.lib.core.function import validate_transaction
...
from TransPose.lib.models import transaction_h
...
def main():
    ...
    if cfg.MODEL.NAME == 'transpose_h':
        ...
        model = transaction_h.get_pose_net(cfg, is_train=False)
    else:
    ...
    validate_transaction(cfg, valid_loader, valid_dataset, model, criterion,
